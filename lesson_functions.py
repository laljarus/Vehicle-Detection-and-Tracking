    ...
    for file in imgs:
        ...
        # Call get_hog_features() with vis=False, feature_vec=True
            ...
            if hog_channel == 'ALL':
                ...
                hog_features = get_hog_features(feature_image_gray,orient,pix_per_cell, cell_per_block, vis=False, feature_vec=True)
...
def draw_labeled_bboxes(img, labels,color=(0,0,255),thickness = 6,area_thres = 100):
